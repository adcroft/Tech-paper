...
def main():
	...
	if plot_melt_comparison is True:
		...
		data1=load_data_from_file(Shelf_ocean_file,field='melt',time_slice='mean',time_slice_num=-1)
		data2=load_data_from_file(Berg_iceberg_file,field='melt_m_per_year',time_slice='mean',time_slice_num=-1) #field name is difference since it comes from a diff file.

		data1=mask_ocean(data1,shelf_area)
		data2=mask_ocean(data2,shelf_area)
		#data3=mask_ocean(data1-data2,shelf_area)
		plt.subplot(1,3,1)
		plot_data_field(data1,x,y,'',vmin,vmax,rotated,colorbar=True,cmap='jet',title='Shelf',xlabel='x (km)',ylabel='y (km)')	
		plt.subplot(1,3,2)
		plot_data_field(data2,x,y,'',vmin,vmax,rotated,colorbar=True,cmap='jet',title='Bergs',xlabel='x (km)',ylabel='')	
		plt.subplot(1,3,3)
		plot_data_field(data1-data2,x,y,'',vmin=-3.,vmax=3.,rotated=rotated,colorbar=True,cmap='bwr',title='Difference',xlabel='x (km)',ylabel='')	
	...
	if plot_bt_stream_comparison is True:
		...
		data1=calculate_barotropic_streamfunction(Shelf_ocean_file,depth,ice_base,time_slice='mean',time_slice_num=-1)
		data2=calculate_barotropic_streamfunction(Berg_ocean_file,depth,ice_base,time_slice='mean',time_slice_num=-1)
		plt.subplot(1,3,1)
		plot_data_field(data1,x,y,'',vmin,vmax,rotated,colorbar=True,cmap='jet',title='Shelf',xlabel='x (km)',ylabel='y (km)')	
		plt.subplot(1,3,2)
		plot_data_field(data2,x,y,'',vmin,vmax,rotated,colorbar=True,cmap='jet',title='Bergs',xlabel='x (km)',ylabel='y (km)')	
		plt.subplot(1,3,3)
		plot_data_field(data1-data2,x,y,'',vmin=-vmax, vmax=vmax, rotated=rotated,colorbar=True,cmap='bwr',title='Difference',xlabel='x (km)',ylabel='')	
	...
	if plot_temperature_cross_section is True:
		...
		plt.subplot(3,1,3)
		plot_data_field(data1-data2, x1, z1, '', vmin=-vdiff, vmax=vdiff, rotated=False, colorbar=True, cmap='bwr')
