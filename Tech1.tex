...
To test the model, the LIISM is used to model an idealized ice shelf cavity which was developed as part of the Marine Ice Ocean Modeling Inter-comparison Project (MISOMIP). Results from static ice shelf experiments compare well to results using a more traditional Eularian ice shelf modles. 
...
\caption{ {Time-averaged barotropic stream function in the (a) Eularian and (b) Lagrangian simulations in the static ice shelf configuration. Panel (c) shows the difference between panels (a) and (b). The time averages are taken over 5 years of model time, beginning at the end of the 5 year spin up period.}}
\end{center}
%FIgure created by \end{center}
...
\caption{ {Snapshots of the fraction of ice cover in the LIISM tabular iceberg calving experiment. Snapshots are taken (a) 15, (b) 30, and (c) 60 days after calving.}}
\end{center}
%FIgure created by \end{center}
...
\caption{ {Snapshots of vertical sections of ocean temperature at $x=70 $km in the LIISM tabular iceberg calving experiment. Snapshots are taken (a) 15, (b) 30, and (c) 60 days after calving.}}
\end{center}
%FIgure created by \end{center}
...
\caption{ {Snapshots of the sea surface temperature in the LIISM tabular iceberg calving experiment. Snapshots are taken (a) 15, (b) 30, and (c) 60 days after calving. Regions with ice area fraction = 1 area plotted in white.}}
\end{center}
%FIgure created by \end{center}
...
\caption{ {Snapshots of vertical sections of meridional velocity at $x=70 $km in the LIISM tabular iceberg calving experiment. Snapshots are taken (a) 15, (b) 30, and (c) 60 days after calving.}}
\end{center}
%FIgure created by \end{center}
...
\caption{ {Results of the tabular iceberg calving simulation 60 days after the iceberg calves. The three panels show snapshots of the (a) melt rate, (b) top-of-ocean temperature and (c) $u^{*}$ at the base of the ice shelf. Fields are only shown in regions where the ice area fraction is $\geq 0.8$.}}
\end{center}
%FIgure created by \end{center}
