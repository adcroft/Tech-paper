...
\caption{ {ALE z , Results of the static ice shelf experiment using the LIISM model. Panels show a cross section of the (a) initial temperature field, (b) temperature anomaly after 5-years (relative the the initial field, and  (c) meridional velocity after 5 years of simulation.}}
\end{center}
%FIgure created by \end{center}
\label{fig:static_solo_temp_temp_v}
\end{figure} 
...
\caption{ {ALE Results of the static ice shelf experiment using the LIISM model. The three panels show 5 year time average of the (a) melt rate, (b) ocean surface temperature and (c) $u^{*}$  in the top layer of the simulation (at the surface or directly below the ice shelf).}}
\end{center}
%FIgure created by \end{center}
\label{fig:static_solo_melt}
\end{figure} 
